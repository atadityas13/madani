...
<div class="modal fade" id="mutasiDoModal" tabindex="-1" aria-labelledby="mutasiDoModalLabel" aria-hidden="true" @if ($bukaModal) data-modal-open @endif>
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <form class="modal-content" method="POST" action="{{ route('mutasi.do.store') }}" data-mutasi-nonaktif-form data-mutasi-stack>
            @csrf
            ...
            <div class="modal-body">
                <div class="mb-3" data-mutasi-step>
                    ...
                    <select class="form-select" id="do_tingkat" name="tingkat_filter" data-tingkat-select data-mutasi-required>
                ...
                <div class="mb-3" data-mutasi-step>
                    ...
                    <select class="form-select @if ($isOld && $errors->has('alasan')) is-invalid @endif" id="do_alasan" name="alasan" required data-mutasi-required>
                ...
                <div class="mb-0" data-mutasi-step>
                    ...
                    <input class="form-control @if ($isOld && $errors->has('tanggal')) is-invalid @endif" type="date" id="do_tanggal" name="tanggal" value="{{ $isOld ? old('tanggal', now()->toDateString()) : now()->toDateString() }}" data-mutasi-required>
                    @if ($isOld)
