        ...
        <form class="modal-content" method="POST" action="{{ route('mutasi.masuk.store') }}" data-mutasi-stack>
            ...
            <div class="modal-body">
                    ...
                    <div class="mb-3" data-mutasi-step>
                        ...
                        <input class="form-control @if ($isOld && $errors->has('nama_sekolah')) is-invalid @endif" id="masuk_nama_sekolah" name="nama_sekolah" value="{{ $oldVal('nama_sekolah') }}" required maxlength="150" data-mutasi-required>
                        @if ($isOld)
                    ...
                    <div class="mb-3" data-mutasi-step>
                        ...
                        <select class="form-select @if ($isOld && $errors->has('alasan')) is-invalid @endif" id="masuk_alasan" name="alasan" required data-mutasi-required>
                            <option value="">Pilih</option>
                    ...
                    <div class="mb-3" data-mutasi-step>
                        ...
                        <input class="form-control @if ($isOld && $errors->has('tanggal')) is-invalid @endif" type="date" id="masuk_tanggal" name="tanggal" value="{{ $oldVal('tanggal', now()->toDateString()) }}" data-mutasi-required>
                        @if ($isOld)
                    ...
                    <div class="mb-3" data-mutasi-step>
                        <label class="form-label" for="masuk_nama">Nama siswa</label>
                        <input class="form-control @if ($isOld && $errors->has('nama')) is-invalid @endif" id="masuk_nama" name="nama" value="{{ $oldVal('nama') }}" required maxlength="150" data-mutasi-required>
                        @if ($isOld)
                    ...
                    <div class="mb-3" data-mutasi-step>
                        ...
                        <input class="form-control @if ($isOld && $errors->has('nisn')) is-invalid @endif" id="masuk_nisn" name="nisn" value="{{ $oldVal('nisn') }}" required maxlength="10" inputmode="numeric" data-mutasi-required>
                        @if ($isOld)
                    ...
                    <div class="mb-3" data-mutasi-step>
                        ...
                        <input class="form-control @if ($isOld && $errors->has('nik')) is-invalid @endif" id="masuk_nik" name="nik" value="{{ $oldVal('nik') }}" required maxlength="16" inputmode="numeric" data-mutasi-required>
                        @if ($isOld)
                    ...
                    <div class="mb-3" data-mutasi-step>
                        ...
                        <input class="form-control @if ($isOld && $errors->has('tempat_lahir')) is-invalid @endif" id="masuk_tempat_lahir" name="tempat_lahir" value="{{ $oldVal('tempat_lahir') }}" required maxlength="100" data-mutasi-required>
                        @if ($isOld)
                    ...
                    <div class="mb-3" data-mutasi-step>
                        ...
                        <input class="form-control @if ($isOld && $errors->has('tanggal_lahir')) is-invalid @endif" type="date" id="masuk_tanggal_lahir" name="tanggal_lahir" value="{{ $oldVal('tanggal_lahir') }}" required data-mutasi-required>
                        @if ($isOld)
                    ...
                    <div class="mb-3" data-mutasi-step>
                        ...
                        <select class="form-select @if ($isOld && $errors->has('jenis_kelamin')) is-invalid @endif" id="masuk_jenis_kelamin" name="jenis_kelamin" required data-mutasi-required>
                            <option value="">Pilih</option>
                    ...
                    <div class="mb-3" data-mutasi-step>
                        ...
                        <select class="form-select @if ($isOld && $errors->has('angkatan')) is-invalid @endif" id="masuk_angkatan" name="angkatan" required data-mutasi-required>
                            <option value="">Pilih</option>
                    ...
                    <div class="mb-3" data-mutasi-step>
                        ...
                        <select class="form-select @if ($isOld && $errors->has('wali_dari')) is-invalid @endif" id="masuk_wali_dari" name="wali_dari" required data-mutasi-required>
                            <option value="">Pilih</option>
                    ...
                    <div class="mb-3" data-mutasi-step>
                        ...
                        <input class="form-control @if ($isOld && $errors->has('nama_ortu')) is-invalid @endif" id="masuk_nama_ortu" name="nama_ortu" value="{{ $oldVal('nama_ortu') }}" required maxlength="150" data-mutasi-required>
                        @if ($isOld)
                    ...
                    <div class="mb-3" data-mutasi-step>
                        ...
                        <select class="form-select @if ($isOld && $errors->has('pekerjaan')) is-invalid @endif" id="masuk_pekerjaan" name="pekerjaan" required data-mutasi-required>
                            <option value="">Pilih</option>
                    ...
                    <div class="mb-3" data-mutasi-step data-mutasi-optional>
                    ...
                    <div class="mb-0" data-mutasi-step data-mutasi-alamat>
