        ...
        return [
            ...
            [
                ...
                'children' => [
                    ...
                    ['label' => 'Mutasi/DO', 'route' => 'mutasi.index', 'roles' => [Peran::SUPERADMIN, Peran::ADMIN]],
            ...
            [
                'label' => 'Aplikasi',
                'icon' => 'bi-phone',
                'match' => ['app-updates.*', 'app-maintenance.*', 'notifikasi.*', 'pengumuman.*', 'calendar-events.*', 'app-menus.*'],
                'roles' => [Peran::SUPERADMIN, Peran::ADMIN],
                'children' => [
                    [
                        'label' => 'Update Ta\'lim',
