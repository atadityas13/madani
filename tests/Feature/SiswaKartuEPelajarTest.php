...
class SiswaKartuEPelajarTest extends TestCase
{
    ...
    public function test_admin_kartu_preview_terpisah_dari_halaman_verifikasi_siswa(): void
    {
        ...
        $this->assertStringContainsString('240.45pt', $html);
        $this->assertStringContainsString('150.8pt', $html);
        $this->assertStringContainsString('card card-front', $html);
        $this->assertStringContainsString('card card-back', $html);
        ...
        $this->assertStringContainsString('ribbon-cut', $html);
        $this->assertStringContainsString('alamat-wrap', $html);
        $this->assertStringContainsString('cap-row', $html);
        $this->assertStringContainsString('ftr-abs', $html);
        $this->assertStringContainsString('bf-abs', $html);
